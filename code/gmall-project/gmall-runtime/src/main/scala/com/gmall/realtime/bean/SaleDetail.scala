...
case class SaleDetail(var order_detail_id: String = null, // 明细id
                      var order_id: String = null, // 订单id
                      var order_status: String = null, // orderinfo
  ...
  def mergeOrderInfo(orderInfo: OrderInfo): SaleDetail = {
    if (orderInfo != null) {
      ...
      this.dt = orderInfo.create_time.substring(0, 10)  // 年月日
