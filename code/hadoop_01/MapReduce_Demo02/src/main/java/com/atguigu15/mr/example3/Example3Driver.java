...
public class Example3Driver {
	...
	public static void main(String[] args) throws Exception {
		...
		// 定义路径
		Path inputPath = new Path("D:\\testdata\\mrinput\\friend");
		Path outputPath = new Path("D:\\testdata\\mroutput\\friend");
		Path finalOutputPath = new Path("D:\\testdata\\mroutput\\friendfinal");

		// 作为整个Job的配置
		Configuration conf1 = new Configuration();
		// KeyValueLineRecordReader在这个类中
