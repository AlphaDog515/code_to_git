...
import com.atguigu.bean.AppActive_background;
import com.atguigu.bean.AppActive_foreground;
import com.atguigu.bean.AppAd;
import com.atguigu.bean.AppBase;
import com.atguigu.bean.AppComment;
import com.atguigu.bean.AppDisplay;
import com.atguigu.bean.AppErrorLog;
import com.atguigu.bean.AppFavorites;
import com.atguigu.bean.AppLoading;
import com.atguigu.bean.AppNewsDetail;
import com.atguigu.bean.AppNotification;
import com.atguigu.bean.AppPraise;
import com.atguigu.bean.AppStart;
...
public class AppMain {
	...
	private static JSONObject generateError() {
		...
		String[] errorBriefs = {
				"at cn.lift.dfdf.web.AbstractBaseController.validInbound(AbstractBaseController.java:72)",
